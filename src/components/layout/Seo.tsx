  ...
  return (
    <DefaultSeo
      ...
      openGraph={{
        ...
        images: [
          {
            url: `https://bafkreicctn5ua3ctzctk62d4vpbsvipzlakdja4hzgh2nkwwauayrf76iy.ipfs.w3s.link/`, // The recommended image ratio for an og:image is 1.91:1 (ie. 1200 x 630)
